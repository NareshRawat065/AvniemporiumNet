<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/WebsiteMaster.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="AvniemporiumNet.Product" %>
                            ...
                            <div class="sidebar-single">
                                ...
                                <div class="sidebar-body">
                                    <ul class="shop-categories">
                                        <li><a href="#">Pendant <span>(10)</span></a></li>
                                        <li><a href="#">Bracellet <span>(5)</span></a></li>
                                        <li><a href="#">Sunglasses <span>(8)</span></a></li>
                                        <li><a href="#">Chain <span>(4)</span></a></li>
                                        <li><a href="#">Earrings <span>(5)</span></a></li>
                                        <li><a href="#">Purse <span>(2)</span></a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- single sidebar end -->
                                    ...
                                    <ul class="checkbox-container categories-list">
                                        ...
                                        <li>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck13">Silver (6)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-control custom-checkbox">
